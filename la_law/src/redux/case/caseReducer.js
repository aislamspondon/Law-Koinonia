import {
  CASE_CATEGORY_VIEW_FAIL,
  CASE_CATEGORY_VIEW_REQUEST,
...
export const caseStudyViewReducer = (state = { cases: [] }, action) => {
  switch (action.type) {
    case CASE_STUDY_VIEW_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case CASE_STUDY_VIEW_SUCCESS:
      return {
        ...state,
        loading: false,
        cases: action.payload,
