...
class Case(models.Model):
    ...
    case_category = models.ForeignKey(Case_Category, on_delete=models.CASCADE, null=True)
    ...
    division = models.ForeignKey(Case_Division, on_delete=models.CASCADE, null=True)
